...
namespace StudioPress\Genesis\Args {
    /**
     * List of all available context values for calling the `genesis_attr()` function.
     *
     * `genesis_attr` may be called with any context value, but the following
     * context has special filters for modifying the attributes.
     *
     * @author Mat Lipe
     * @since  3.5.0.19
     */
    class Genesis_Attr
    {
        public const ADJACENT_ENTRY_PAGINATION = 'adjacent-entry-pagination';
        public const ARCHIVE_PAGINATION = 'archive-pagination';
        public const AUTHOR_ARCHIVE_DESCRIPTION = 'author-archive-description';
        public const BLOG_TEMPLATE_DESCRIPTION = 'blog-template-description';
        public const BODY = 'body';
        public const BREADCRUMB_LINK = 'breadcrumb-link';
        public const BREADCRUMB_LINK_WRAP_META = 'breadcrumb-link-wrap-meta';
        public const COMMENT = 'comment';
        public const COMMENTS_PAGINATION = 'comments-pagination';
        public const COMMENT_AUTHOR_LINK = 'comment-author-link';
        public const COMMENT_TIME_LINK = 'comment-time-link';
        public const CONTENT = 'content';
        public const CPT_ARCHIVE_DESCRIPTION = 'cpt-archive-description';
        public const DATE_ARCHIVE_DESCRIPTION = 'date-archive-description';
        public const ENTRY = 'entry';
        public const ENTRY_AUTHOR_LINK = 'entry-author-link';
        public const ENTRY_COMMENTS = 'entry-comments';
        public const ENTRY_IMAGE = 'entry-image';
        public const ENTRY_IMAGE_LINK = 'entry-image-link';
        public const ENTRY_IMAGE_WIDGET = 'entry-image-widget';
        public const ENTRY_META_AFTER_CONTENT = 'entry-meta-after-content';
        public const ENTRY_META_BEFORE_CONTENT = 'entry-meta-before-content';
        public const ENTRY_PAGINATION = 'entry-pagination';
        public const ENTRY_TITLE = 'entry-title';
        public const ENTRY_TITLE_LINK = 'entry-title-link';
        public const FOOTER_WIDGET_AREA = 'footer-widget-area';
        public const HEAD = 'head';
        public const HEADER_WIDGET_AREA = 'header-widget-area';
        public const NAV_HEADER = 'nav-header';
        public const NAV_LINK = 'nav-link';
        public const NAV_LINK_WRAP = 'nav-link-wrap';
        public const NAV_PRIMARY = 'nav-primary';
        public const NAV_SECONDARY = 'nav-secondary';
        public const PAGINATION_NEXT = 'pagination-next';
        public const PAGINATION_PREVIOUS = 'pagination-previous';
        public const POSTS_PAGE_DESCRIPTION = 'posts-page-description';
        public const SEARCH_FORM = 'search-form';
        public const SEARCH_FORM_INPUT = 'search-form-input';
        public const SEARCH_FORM_LABEL = 'search-form-label';
        public const SEARCH_FORM_META = 'search-form-meta';
        public const SEARCH_FORM_SUBMIT = 'search-form-submit';
        public const SIDEBAR_PRIMARY = 'sidebar-primary';
        public const SIDEBAR_SECONDARY = 'sidebar-secondary';
        public const SINGULAR_ENTRY_IMAGE = 'singular-entry-image';
        public const SITE_FOOTER = 'site-footer';
        public const SITE_HEADER = 'site-header';
        public const STRUCTURAL_WRAP = 'structural-wrap';
     ...
     * @since  3.5.0.19
     *
     * @phpstan-type CopyrightArgs array{
     *     after: string,
     *     before: string,
     *     copyright: string,
     *     first: string
     * }
     *
     * @implements ArgsRules<\Partial<CopyrightArgs>>
     */
    final class Genesis_Footer_Copyright_Shortcode implements \Lipe\Lib\Args\ArgsRules
    {
        /**
         * @use Args<\Partial<CopyrightArgs>>
         */
        use \Lipe\Lib\Args\Args;
        /**
         * The copyright text.
         *
         * default is copyright character like (c)
         *
         * @var string
         */
        public string $copyright;
        /**
         * The text to display before the copyright.
         *
         * @var string
         */
        public string $before;
        /**
         * The text to display after the copyright.
         *
         * @var string
         */
        public string $after;
        /**
         * First year the copyright was established.
         *
     ...
     * }
     * @implements ArgsRules<\Partial<MarkupArgs>>
     */
    class Genesis_Markup implements \Lipe\Lib\Args\ArgsRules
    {
        /**
         * @use Args<\Partial<MarkupArgs>>
         */
        use \Lipe\Lib\Args\Args;
        /**
         * Initial attributes to apply to `open`, before filters.
         *
         * @var array<string, string>
         */
        public array $atts = [];
        ...
        public string $close;
        /**
         * The content to be wrapped in the markup.
         *
         *
         * @var string
         */
        ...
        public string $context;
        /**
         * Whether to echo the markup or return it.
         *
         * Default true, echo the markup.
         *
         * @var bool
         */
        public bool $echo;
        ...
        public string $open = '';
        /**
         * Additional information/data to pass to the various filters.
         *
    ...
    /**
     * List of all available post type support values used by Genesis
     * to enable features
     *
     * @notice Cannot be used until the `after_setup_theme` hook is fired.
     *
     * @author Mat Lipe
     * @since  3.6.0.3
     *
     */
    class Genesis_Post_Type_Support
    {
        public const ADJACENT_ENTRY_NAV = 'genesis-adjacent-entry-nav';
        public const AFTER_ENTRY_WIDGET_AREA = 'genesis-after-entry-widget-area';
        public const BREADCRUMBS_TOGGLE = 'genesis-breadcrumbs-toggle';
        public const CPT_ARCHIVES_SETTINGS = 'genesis-cpt-archives-settings';
        public const ENTRY_META_AFTER_CONTENT = 'genesis-entry-meta-after-content';
        public const ENTRY_META_BEFORE_CONTENT = 'genesis-entry-meta-before-content';
        public const FOOTER_WIDGETS_TOGGLE = 'genesis-footer-widgets-toggle';
        public const LAYOUTS = 'genesis-layouts';
        public const SCRIPTS = 'genesis-scripts';
        public const SEO = 'genesis-seo';
        public const SINGULAR_IMAGES = 'genesis-singular-images';
        public const TITLE_TOGGLE = 'genesis-title-toggle';
        /**
         * Add default genesis supports to a post type.
         *
         * Similar to the `genesis_post_type_support` function but
         * does not include unusual support values for custom post types.
         *
         * @see genesis_post_type_support
         *
         * @param Register_Post_Type $register
         *
         * @return void
         */
        public function add_default_support(\Lipe\Lib\Post_Type\Register_Post_Type $register): void
        {
        }
    }
}
namespace {
    ...
    abstract class Genesis_Admin
    {
         ...
         * @since 2.10.0
         *
         * @return void Return early if no redirect destination is set, or if a special query flag is set, or if we're not on this menu page
         *              URL.
         */
    ...
    class Genesis_Update_Check
    {
        ...
        public function download_package(string $package): \WP_Error|string
        {
        }
        /**
         * Validate the format and data of the update response.
         *
         * @param array|mixed $response The response to validate.
         *
         * @return array Empty array if invalid, otherwise unaltered response.
         */
        protected function validate_response(mixed $response): array
        {
        }
        /**
         ...
         */
        protected function get_response(): \WP_Error|array
        {
        }
        /**
        ...
        /**
         * Get the update-check configuration from the /config file.
         *
         * @return array
         */
        public static function get_update_config(): array
        {
        }
    }
}
namespace StudioPress\Genesis\SEO {
    ...
    final class Sitemaps
    {
        ...
        /**
         * Exclude posts that have the no-index meta tag.
         *
         ...
         */
        public function exclude_no_index_posts(array $args, string $post_type): array
        {
        }
    }
}
namespace StudioPress\Genesis\Upgrade {
     ...
     *
     */
    final class Upgrade_DB_33011 implements \StudioPress\Genesis\Upgrade\Upgrade_DB_Interface
    {
        /**
         * Delete the the noindex meta key from all posts which have it
         * set to anything other than 1 (true).
         *
         * Allows us to start querying against the noindex meta key on EXISTS.
         */
...
namespace {
    ...
    function genesis_is_webpack_running(): bool
    {
    }
    function genesis_custom_js_manifest(string $file): array
    {
    }
    /**
     * Genesis Framework.
     ...
     *
     * @since 1.3.0
     * @since 3.5.0.15 Added the `$context` parameter.
     *
     * @param ?string $context - Context of the page being loaded for using a custom
     *                           header and/or footer. Default is null.
     */
    function genesis(?string $context = \null)
    {
    }
    /**
     * Genesis Framework.
     ...
     * @since 2.0.0
     *
     * @phpstan-param Genesis_Attr::* $context
     *
     * @param string $context    The context, to build filter name.
     * @param array  $attributes Optional. Extra attributes to merge with defaults.
     * @param array  $args       Optional. Custom data to pass to filter.
     ...
     */
    /**
     * Short curcuit the theme update downloaded to add authentication
     * headers to the GitHub API URL.
     *
     * @param false|string $false - False is default, other filters may short-circuit the request.
     * @param string       $package
     *
     * @return string|false|\WP_Error
     */
    function genesis_handle_update_download($false, $package)
    {
    }
    /**
     ...
     *
     * @see   \Lipe\Lib\Theme\Register_Sidebar for a fluent interface.
     *
     * A typical usage is:
     *
     * ~~~
     ...
     * @since 1.0.1
     *
     * @deprecated 1.6.0 Use `genesis_register_widget_area()` instead.
     *
     * @param string|array $args Name, ID, description and other widget area arguments.
     * @return string The sidebar ID that was added.
     */
     ...
     * @since 1.1.0
     *
     * @see   Genesis_Footer_Copyright_Shortcode for a fluent interface.
     *
     * Output passes through `genesis_footer_copyright_shortcode` filter before returning.
     *
     * @param string|array|Genesis_Footer_Copyright_Shortcode $atts Shortcode attributes. Empty string if no attributes.
     *
     * @return string Output for `footer_copyright` shortcode.
     */
    function genesis_footer_copyright_shortcode(string|array|\StudioPress\Genesis\Args\Genesis_Footer_Copyright_Shortcode $atts): string
    {
    }
    /**
     ...
     *
     * Adds support for genesis meta in block-based templates.
     *
     * @see locate_block_template
     */
    function genesis_block_theme_head(string $template): string
    {
    }
    /**
     * For rendering genesis meta when not using the genesis header.php
     *
     * @return void
     */
